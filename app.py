...
class TodoApp(NextPyComponent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.name = "Todo App"
        self.state = {"todos": [], "new_todo": ""}
        self.components = {"todo-item": TodoItem}
            ...
            self.set_state(
                {
                    ...
                    + [{"text": self.state["new_todo"], "completed": False}],
                    "new_todo": "",
                }
            )
    ...
    def update_new_todo(self, value):
        self.set_state({**self.state, "new_todo": value}, rerender=False)
